- dashboard: flightstats__safety__delays
  title: Flightstats - Safety & Delays
  layout: newspaper
  ...
  - name: Sign-ins is under construction.
    ...
    body_text: |-
      ...
      <center><img src="https://logo-core.clearbit.com/looker.com" class="center" width="50%" height = "50%" /></center>
  ...
  - name: Subtotals
    ...
    - table_calculation: percent_of_total
      ...
      expression: "${orders.count}/${orders.count:total}"
      value_format:
